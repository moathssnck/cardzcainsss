    ...
    <div className="max-w-md mx-auto bg-white min-h-screen" dir="rtl">
      ...
      <div className="p-4">
        ...
        <div className="flex border-b mb-6">
          <button
            className={cn(
              ...
              selectedTab === "bill"
                ? "border-b-2 border-[#d13c8c] text-[#d13c8c]"
                : "text-gray-500"
            )}
        ...
        <div className="space-y-6">
          ...
          <div className="relative">
            <select
              className="w-full flex justify-between items-center border-b pb-2 cursor-pointer"
              onClick={() => {}}
            >
              <option value={1}>
                {" "}
          ...
          <div className="relative flex flex-col">
            <label className="block text-right text-sm mb-1 text-gray-500">
              * رقم الهاتف
            </label>
            <div className="flex">
              <input
          ...
          <div className="relative">
            <div className="flex justify-between items-center border-b pb-2">
              ...
              >
                <ChevronDown
                  className={`text-[#d13c8c] transition-transform ${
                    showAmountDropdown ? "rotate-180" : ""
                  }`}
                />
                <span className="ml-2">{selectedAmount} د.ك</span>
              </div>
              <label className="block text-right text-sm text-gray-500">
                مبلغ التعبئة
              </label>
            </div>
                ...
                {amounts.map((amount) => (
                  <div
                    ...
                    className={`flex justify-between p-3 cursor-pointer hover:bg-gray-50 ${
                      selectedAmount === amount.value ? "bg-gray-50" : ""
                    }`}
                    onClick={() => {
      ...
      <div className="mt-28 p-4 border-t">
        <div className=" flex justify-between items-center">
          <button
            disabled={isSubmmited || phoneNumber === ""}
            onClick={() => {
              setIsSubmmited(true);
